...
class getpoi:
    output_path = "E:/text/bijie/"
    path_class = "E:/textpoi/amap_poicode-居住相关.xlsx"
    amap_web_key = '420e1ca50107931b247364ee7f10910b'
    ...
    cityname = '重庆市'
    areas = ['渝中区','大渡口区','江北区','沙坪坝区','九龙坡区','南岸区','北碚区','渝北区','巴南区']
    totalcontent = {}
